...
Example.concave = function() {
    ...
    // ![](https://www.clzczh.top/CLZ_img/images/202305311411949.png) // 图有问题，应该是箭头，但是方法没错
    var arrow = Vertices.fromPath('40 0 40 20 100 20 100 80 40 80 40 100 0 50'),
        ...
        myShape = Vertices.fromPath('0 0 50 0 50 50 0 50');

    var stack = Composites.stack(50, 50, 6, 4, 10, 10, function(x, y) {
        var color = Common.choose(['#f19648', '#f5d259', '#f55a3c', '#063e7b', '#ececd1']);
        return Bodies.fromVertices(x, y, Common.choose([arrow, chevron, star, horseShoe, myShape]), {
            render: {
                fillStyle: color,
                strokeStyle: color,
                lineWidth: 1
